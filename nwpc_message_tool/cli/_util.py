...
def parse_start_time(
    ...
    """
    Parse start time string for command options.

    Parameters
    ----------
    start_time: str
        start time, including:
            - YYYYMMDDHH: single date
            - YYYYMMDDHH/YYYYMMDDHH: date range generated by `pandas.date_range`
            - YYYYMMDDHH, YYYYMMDDHH, ...: date list
    start_time_freq: str
        used for data range.

    Returns
    -------
    datetime.datetime or typing.Tuple[datetime.datetime] or typing.List[datetime.datetime]:
